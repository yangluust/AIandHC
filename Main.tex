...
The AI shock increases sectoral labor productivity for the low and high sectors in period 2. Its effect on saving can be analyzed as if we are varying the parameter $t$ in the functions $\Delta(x,a;t)$, defined in \eqref{eq:dadt_integral}, and $\Delta_{H}(x,a;t)$, defined in \eqref{eq:dadt_fulltime}. 
...
\paragraph{Households who downskill} Downskilling is caused by human capital depreciation. For high-sector households who transition downward, the AI shock leaves their future productivity -- and thus their saving -- unchanged.
