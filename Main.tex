...
\right. 
\end{equation}
As a result, some households whose human capital falls between the old and new thresholds, that is, $h_H < h' < h_H'$, will be reclassified from high-sector to middle-sector employment. We refer to this specification as the \textbf{AI+ experiment}.
...
The additional component of AI is that the human-capital threshold between the middle and high sectors increases as in \eqref{eq:xAI_expand}. We calibrate the new threshold $h_H'$ such that the middle-sector population share in the initial steady state is increased from 40\% to 45\%, relative to the benchmark model. In other words, 5\% population will be reclassified out of high-sector employment due to the AI shock if their human capital remains the same. \textcolor{red}{Please edit this part if you think it is not clear or correct.} 

Our analysis centers on the baseline component and examines the additional component only insofar as it qualifies the baseline results.
...
\begin{figure}
    ...
    In the AI+ experiment, the additional component of AI raises the bar for high-sector employment. Relative to the baseline results discussed above, the rising bar of high-sector employment significantly increases the human capital investment by the high-sector households. \textcolor{red}{Use the figures of population share and total human capital in high sector to support this claim.}
...
\subsection{AI+ Counterfactual: Shifting the High-Skill Cutoff }
