...
Suppose that an AI shock is anticipated to increase the labor productivity for the low sector and the high sector but not the middle sector. The effect of AI shock on the sectoral productivity is captured by $\gamma$ with $0<\gamma<1$:
\begin{equation}
    \label{eq:xAI}
x(h')=\left \{ 
\begin{array}{cl}
...
\right. 
\end{equation}
where $h'$ is the human capital in the future period.
