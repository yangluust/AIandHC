...
\subsubsection{Baseline component: AI changes skill premium}
Suppose that an AI shock is to increase the labor productivity for the low sector and the high sector but not the middle sector. The effect of AI shock on the sectoral productivity is captured by $\gamma$ with $0<\gamma<1$:
\begin{equation}
    \label{eq:xAI}
x(h')=\left \{ 
\begin{array}{cl}
...
The AI shock influences labor supply and saving through two main channels: directly, by altering households’ period-2 labor income, and indirectly, by affecting their human capital investment decisions. In what follows, we focus on the indirect effects, while the more standard direct channel is discussed in Appendix \ref{appsec: AIeffects}.
...
We now introduce an additional component to the anticipated AI shock, motivated by recent labor market evidence that AI exposure leads to reduced demand for junior hires in many college-level roles: the opportunity to enter the high sector contracts -- in other words, the cutoff for high-sector employment 
rises from $h_H$ to $h_H'>h_H$. 
With this additional component of AI shock, period-2 sectoral productivity becomes:
\begin{equation}
    \label{eq:xAI_expand}
x^{AI+}(h')=\left \{ 
\begin{array}{cl}
