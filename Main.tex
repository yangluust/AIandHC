...
As discussed in Section \ref{sec:saving}, the effect of human capital investment on saving is theoretically ambiguous ex ante. On the one hand, higher expected future income from part-time and full-time training tends to crowd out saving through the standard consumption-smoothing motive. On the other hand, greater exposure to idiosyncratic risk strengthens the precautionary saving motive and can crowd in saving. Propositions ~\ref{prop:dadt} and ~\ref{prop:fulltime} demonstrate that, when idiosyncratic risk is sufficiently large, human capital investment crowds out saving for low-labor-income households but crowds in saving for high-labor-income households. As labor income is positively affected by households productivity, the net effect of human capital investment on saving is positive precisely for the more productive households.
...
In our quantitative model, this mechanism shows up most clearly in the middle sector. Figure~\ref{fig:asset_sector} plots the transition of average assets by sector in the benchmark economy and in the counterfactual No HC economy. “Average Asset” is defined as total assets held by households in a given sector divided by that sector’s population share, so it reflects both within-sector saving behavior and the composition of households across sectors.
...
\begin{figure}
\begin{centering}
\caption{\protect\label{fig:AI_plus}Transition Path of Aggregate Variables in the AI+ experiment:
Benchmark vs. No HC Models.}
\includegraphics[width=0.9\linewidth]{figure_204040calib/nohc_agg_plus.pdf}
\par\end{centering}


{\scriptsize Note:  The transition paths of aggregate variables in the AI+ experiment: benchmark vs. No HC models. The x-axis represents years, and the y-axis shows the percentage deviation from the initial steady state. AI introduction is assumed to occur in period 10. The No HC model is an economy in which workers maintain their initial steady-state level of human capital throughout the AI implementation until the new steady state is reached. }{\scriptsize\par}
\end{figure}


This design isolates a mechanism that is specific to AI: rather than only making existing tasks cheaper or faster, AI can redefine what firms consider to be “high-skill” work by raising the bar for entry and retention. As a result, some workers who would have been classified as high-skill in the baseline economy are mechanically reclassified into the middle sector after the cutoff shift. An important implication is that some of the workers who benefit from AI in the baseline experiment no longer receive the direct productivity boost under this counterfactual. Intuitively, these are workers who previously sat near the lower end of the high-skill group: when the cutoff rises, they are now labeled as middle-skill, and the middle sector does not experience the same direct AI productivity increase as the high sector in our baseline specification. Consequently, the direct aggregate impact of AI is smaller in this counterfactual because a smaller fraction of workers is immediately exposed to the high-skill productivity gain.

Figure~\ref{fig:AI_plus} reports the transition dynamics of key aggregate variables in the AI+ experiment, comparing the benchmark model (the model with endogenous human-capital accumulation) to the No-HC model (the model in which human capital is held fixed). Qualitatively, the responses remain similar to the baseline AI experiment: AI adoption raises real activity over the transition. Quantitatively, however, the expansion is markedly weaker when human capital cannot adjust. In the AI+ experiment, the long-run increase in output in the No-HC economy is substantially smaller than in the baseline AI experiment, reflecting that the higher high-skill cutoff mechanically shifts some would-be high-sector workers into the middle sector and thereby attenuates AI’s direct productivity impact. At the same time, the cutoff shift makes the human-capital channel more powerful. By raising the threshold for high-skill employment, AI+ increases the payoff to skill accumulation for workers near the upper end of the middle sector, who can regain access to the high sector—and its productivity gains—only by investing in human capital. As a result, indirect effects operating through endogenous human-capital adjustment become relatively more important, widening the gap between the benchmark and no-human-capital economies. Overall, this counterfactual underscores that AI can reshape aggregate dynamics not only by changing productivity within sectors, but also by shifting sector boundaries, which in turn strengthens the quantitative role of human-capital accumulation during the transition.


\begin{figure}
\begin{centering}
\caption{\protect\label{fig:AI_plus_gini}Transition Path of Inequality Measures in the AI+ experiment:
Benchmark vs. No HC Models.}
\par
\includegraphics[width=0.95\linewidth]{figure_204040calib/nohc_gini_plus.pdf}
\par\end{centering}
{\scriptsize Note:  The transition paths of inequality measures in the AI+ experiment: benchmark vs. No HC models. The x-axis represents years, and the y-axis shows the percentage deviation from the initial steady state. AI introduction is assumed to occur in period 10. The No HC model is an economy in which workers maintain their initial steady-state level of human capital throughout the AI implementation until the new steady state is reached.}{\scriptsize\par}

\end{figure}


Figure~\ref{fig:AI_plus_gini}  reports the transition dynamics of inequality measures (income, earnings, consumption, and wealth Gini coefficients) in the AI+ experiment. Relative to the baseline AI experiment, the inequality responses can differ substantially because the cutoff shift changes both the composition of each sector and the incentives to invest in human capital near the boundary. In particular, wealth inequality becomes especially informative about the underlying mechanism. In the AI+ experiment, the higher high-skill cutoff raises the returns to “staying” (or becoming) high-skill, strengthening human-capital investment incentives among relatively productive households.\footnote{Consistent with this mechanism, human-capital inequality—as summarized by the human-capital Gini—rises more in the AI+ experiment than in the baseline AI case.} As emphasized by Propositions ~\ref{prop:dadt} and ~\ref{prop:fulltime}, additional human-capital investment by high-income (high-productivity) households can crowd in saving through the precautionary-savings motive. If the AI+ cutoff shift concentrates incremental training (and thus incremental saving) more strongly in the upper part of the distribution—rather than in the middle—asset accumulation tilts upward and the wealth Gini rises relative to the baseline AI experiment. 
