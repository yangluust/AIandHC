...
\subsubsection{The effects of access contraction to high sector}
...
them for the post-AI labor market.\footnote{To emphasize this key difference, our model deliberately abstracts from any direct negative effect of AI on middle-sector workers.}   This mechanism is formally characterized in  Proposition (\ref{prop:AI_human_capital}) in the two period model above.
...
\begin{figure}
    ...
    In the AI+ experiment, the additional component of AI raises the bar for high-sector employment. Relative to the baseline results discussed above, the rising bar of high-sector employment significantly increases the human capital investment by the high-sector households. \textcolor{red}{Use the figures of population share and total human capital in high sector to support this claim. Move the asset holding figure to the next section.}
    
    
    This design captures a mechanism that is especially relevant for AI: the technology does not merely make existing workers more productive, but can also redefine what firms consider to be “high-skill” work by raising the threshold for access to the high sector. As a result, some workers who would previously have remained in the high sector are reclassified into the middle sector unless they invest more in human capital. In the simple model, this gives rise to the clear \textbf{churning effect}, as discussed in Section 3.4: workers near the old high-skill cutoff face stronger incentives to invest in order to preserve access to the high sector, while those too far below the new cutoff may instead reduce learning because the high sector has become unattainable. Figure~\ref{fig:AI_plus_high} shows the transition dynamics of the high-sector population share, total human capital, and average assets in the AI+ experiment.\footnote{See Figure \ref{fig:AI_plus_all}  for the corresponding transition dynamics across all sectors in the AI+ experiment.} On the one hand, the higher cutoff mechanically reduces access to the high sector in both models, so the high-sector population share initially falls. In the No-HC model, this mechanical effect remains dominant, and both the high-sector share and total human capital decline because households cannot respond through additional skill accumulation. On the other hand, in the benchmark model, the tighter cutoff gives rise to the churning effect by reshuffling households across learner types near the middle-to-high boundary: some households invest more in order to retain or regain access to the high sector, while others stop upgrading if the new threshold is out of reach. 
...
We now turn to the effects of AI on asset inequality. Because human-capital adjustment is an important channel through which AI affects the wealth Gini, it is useful to begin with the dynamics of human-capital inequality. 

As shown in Figure~\ref{fig:no_hc_gini}, the human-capital Gini rises following the AI adoption. The mechanism is relatively straightforward. The AI induces heterogeneous adjustments in human-capital investment across households: middle-sector households respond more strongly to the increase in returns to skill, whereas low-sector households reduce human-capital investment, as shown in Figure~\ref{fig:hc_dist}.  This divergence in investment behavior increases dispersion in human capital. The pattern is established formally in Proposition~\ref{prop:AI_human_capital}.
