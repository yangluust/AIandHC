...
The additional component of AI is that the human-capital threshold between the middle and high sectors increases as in \eqref{eq:xAI_expand}. We calibrate this threshold shift so that the middle-sector population share in the initial steady state rises by 5 percentage points, holding everything else fixed. \textcolor{red}{We need to explain more on what holding everything else fixed means.} We refer to this specification as the \textbf{AI+ experiment}.
