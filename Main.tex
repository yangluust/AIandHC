...
The AI shock lowers the incentive to work in the middle sector in period 2. Consequently, households with $h < h_M/(1-\delta)$ reduce their human capital investment, while those with $h > h_M/(1-\delta)$ increase it. More specifically, the upper bounds that determine whether households undertake positive human capital investment -- denoted by $\overline{z}^L_{full}$ and $\overline{z}^L_{part}$ for $h < h_M/(1-\delta)$, and $\overline{z}^M_{full}$ and $\overline{z}^M_{part}$ for $h > h_M/(1-\delta)$ -- respond in opposite directions to the anticipated shock: the former decrease with $\gamma$ and the latter increase. This relationship is formalized below.
...
The AI shock influences saving decisions through two main channels. First, it alters the human capital investment choices of some households (see Proposition \ref{prop:AI_human_capital}), which in turn affects their saving behavior (see Propositions \ref{prop:dadt} and \ref{prop:fulltime}). Second, for households whose human capital investment decisions remain unchanged, the AI shock impacts their saving by changing period-2 sectoral productivity.

\paragraph{Households who change human capital investment}
According to Proposition \ref{prop:AI_human_capital}, households with $h < h_M/(1-\delta)$ (low-income) decrease, while those with $h > h_M/(1-\delta)$ (high-income) increase their human capital investment following the AI shock. In both cases, as established in Propositions \ref{prop:dadt} and \ref{prop:fulltime}, when the AI shock causes low-income households to stop investing in human capital or high-income households to begin investing, their optimal saving \textit{increases}.

\paragraph{Households who do not change human capital investment}
...
\subsubsection{An additional component: AI contracts access to high sector}
The AI shock in \eqref{eq:xAI} changes sectoral productivities in period 2. 
...
\right. 
\end{equation}
We assume that the rise in the high-sector cutoff takes place only in period 2, meaning that period-1 sectoral productivities remain as given in \eqref{eq:x}. Note that if we set $h_H' = h_H$, we recover the baseline AI shock in \eqref{eq:xAI} as a special case.
