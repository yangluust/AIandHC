...
\subsection{AI Shock}
AI differs from earlier waves of technological change because it can perform a broad range of cognitive and non-routine tasks across many occupations. This gives rise to two distinct effects. 

First, AI raises productivity in occupations whose task bundles are complementary to it, particularly low-sector jobs that combine service delivery with information processing, such as delivery or customer-service work, and high-sector jobs that combine expert judgment with research, drafting, or diagnostic tasks, such as consulting, law, or medicine. By contrast, middle-sector occupations such as production supervisors, office managers, logistics coordinators, or maintenance technicians are likely to be less affected, because their core tasks remain centered on implementation, coordination, and hands-on problem-solving. 

Second, AI may erode the task content that previously justified 
high-sector classification for marginal occupations, thereby 
shifting the boundary of what counts as a high-sector occupation.  Recent labor market evidence illustrates this, showing that AI exposure has led to decreased demand for junior hires in many college-level positions.

We capture the impact of an AI shock as a foreseeable change expected to occur in a future period. This shock consists of two distinct components: a baseline component that alters the skill premium and an additional component that reduces accessibility to the high sector.
...
\subsubsection{Additional component: AI contracts access to high sector}
...
In our framework, this corresponds to a shift in the cutoff in the human-capital distribution that separates the middle and high sectors. The baseline AI experiment in the paper increases productivity in the same sectors as before while leaving the remaining sector unchanged. In this counterfactual, we keep all of those baseline AI productivity changes exactly the same. The only additional change is that the human-capital cutoff between the middle and high sectors increases. We calibrate this cutoff shift so that the middle-sector population share rises by 5 percentage points, holding everything else fixed. We refer to this specification as the \textbf{AI+ experiment}.
