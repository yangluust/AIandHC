...
\vspace{0.6cm}
~\\
{\large\color{blue}NAESM, Atlanta}}
\date{{\normalsize\textrm{June 4, 2026}}}
...
\begin{enumerate}
\item \textbf{\textcolor{blue}{Baseline experiment:}} AI raises labor productivity in the low and high sectors 
\item \textbf{\textcolor{brown}{AI+ experiment:}}\textcolor{brown}{{} }AI raises the HC threshold for high-sector entry
\end{enumerate}
...
\medskip{}
  ...
  \begin{itemize}
  \item HC investment crowds out saving for low-income HHs but crowds in saving for high-income HHs
  \item AI shock reduces HC investment for low-HC HHs but increases it for high-HC HHs
  \end{itemize}
...
\begin{itemize}
\item AI generates\textbf{ voluntary job polarization}
\item HC adjustment amplifies AI's positive effects on GDP, consumption, and investment, but mitigates its effects on employment
