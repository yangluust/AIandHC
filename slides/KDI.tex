...
\vspace{0.6cm}
~\\
{\large\color{blue}Academia Sinica}}
\date{{\normalsize\textrm{July 21, 2026}}}
...
\medskip{}
  ...
  \begin{itemize}
  \item HC investment \textcolor{red}{\textbf{crowds out}} saving for \textcolor{red}{\textbf{low-income}} HHs and \textcolor{blue}{\textbf{crowds in}} saving for \textcolor{blue}{\textbf{high-income}} HHs.
  \item AI shock \textcolor{red}{reduces} HC investment for \textcolor{red}{low-HC} HHs but \textcolor{blue}{increases} it for \textcolor{blue}{high-HC} HHs.
  \end{itemize}
...
\item HC adjustment \textcolor{red}{amplifies} AI's positive effects on GDP, consumption, and investment, but \textcolor{blue}{mitigates} its effects on employment
