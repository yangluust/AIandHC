...
We assume that $z$ follows the AR(1) process in logs: $\log z'=\rho_{z}\log z+\epsilon_{z}$,
...
probability matrix with 11 grids. We set the persistence parameter to $\rho_{z} = 0.948$ and the standard deviation to $\sigma_{z} = 0.269$, following the estimates reported in \citet{Chang2006}.
