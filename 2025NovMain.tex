...
When households upskill via on-job-training, the low-sector houesholds do not change their saving as the AI shock does not alter their future productivity gain after they upskill. For the middle-sector households, the AI shock improves their future productivity gain from $\lambda$ to $(1+\gamma)\lambda$. This is equivalent to an increase of $t$ in the on-job-training effect on saving, $\Delta_{\text{on-job}}(x,a;t)$. 

their saving's response depends on their current sectoral productivity, according to Proposition \ref{prop:dadt}. As 
...
The total effect of human capital investment on saving is
\begin{equation}
