...
\begin{align*}
    \overline{z}^L_{full}(a;\gamma)&= \overline{z}^L_{full}(a;\gamma=0) - \gamma \lambda  \frac{w'z'}{w(1+r')}\\
    \overline{z}^L_{part}(a;\gamma)&= \overline{z}^L_{part}(a;\gamma=0) - \gamma \lambda \frac{w'z'}{w(1+r')}\frac{\exp(\frac{\chi_e e_L}{1+\beta})}{\exp(\frac{\chi_e e_L}{1+\beta})-1} \\
    \overline{z}^M_{full}(a;\gamma)&=\overline{z}^M_{full}(a;\gamma=0) + \gamma \lambda \frac{w'z'}{w(1+r')}\exp(\frac{\chi_n-\chi_e e_H}{1+\beta})\\
    \overline{z}^M_{part}(a;\gamma)&= \overline{z}^M_{part}(a;\gamma=0) + \gamma \lambda \frac{w'z'}{w(1+r')}\frac{1}{\exp(\frac{\chi_e e_L}{1+\beta})-1}
\end{align*}
