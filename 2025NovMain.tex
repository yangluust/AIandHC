...
\begin{proposition}\label{prop:convexity_onjob}
    $\Delta_{\text{on-job}}(x,a;t)$ is a convex function of $t$. 
    \begin{itemize}
...
When households upskill via full-time training, the dominant intensive-margin effect on saving is via forgoing their period-1 labor income, which is not affected by the AI shock. The AI shock only affects the extensive margin of full-time training. The low-sector households has weaker incentive for full-time training after the AI shock and therefore save more. The middle-sector households has stronger incentive for full-time training after the AI shock and therefore save less.



\paragraph{Households who will downskill to a lower sector}
They must have $e=0$. Facing downskilling makes households' saving differ from a fixed human capital senario by $\Delta_{\text{on-job}}(x,a;t)$ with $t<1$. For the high-sector households who will downskill to the middle sector, the AI shock has no effect on their future productivity loss and therefore their saving. For the middle-sector households who will downskill to the low sector, the AI shock mitigates their future productivity loss from $\lambda$ to $(1-\gamma)\lambda$. This is equivalent to an increase of $t$ to $t'$ where $t'<1$. If $\Delta_{\text{on-job}}(x,a;t<1)>0$, the AI shock will mitigate the positive effect and reduces households' saving. 
...
\subsection{Proof of Proposition \ref{prop:convexity_onjob}}
