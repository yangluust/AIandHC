...
\begin{equation}
h_{t+1}=z_te_t + (1-\delta_h)h_t
\end{equation}
where $\delta_h$ is human capital's depreciation rate.  We interpret $z_t e_t$ as effective human-capital investment, with $z_t$ capturing a learning-ability shock.\footnote{Equivalently, one can think of an underlying learning-ability term that is perfectly correlated with $z_t$. This allows us to reduce the dimensionality of the state space.}
