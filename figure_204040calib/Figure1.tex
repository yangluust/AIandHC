...
% non-learners region (0 to \underline{h}_M(y)) intentionally left unshaded
...
\node[right] at (4,\zSlow) {\small $\overline{z}^L_{full}$};

% Fast-learner cutoffs
\draw[dashed] (4,\zFastL) -- (6,\zFastL);
\draw[dashed] (4,\zFastU) -- (6,\zFastU);
\node[right] at (6,\zFastL) {\small $\underline{z}^L_{part}$};
\node[right] at (6,\zFastU) {\small $\overline{z}^L_{part}$};
