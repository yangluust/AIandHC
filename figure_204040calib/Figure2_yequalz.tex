...
\draw[dashed] (3,1.5) -- (2,1.5)  node[above right] {$\overline{z}^L_{slow}$}; % Third dashed line
...
\draw[dashed] (7.5,2) -- (5.3,2) node[above] {$\overline{z}^M_{slow}$}; % Third dashed line
...
\draw[dashed]  (8.9,1.1) --(7.5,1.1) node[above right] {$\frac{\overline{z}^M_{slow}}{1+\lambda}$}; % Third dashed line
